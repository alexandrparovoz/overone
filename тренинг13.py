# сортировка слиянием
# суть в разбиении списка на части и сравнение элементов из разных частей

# funtion to divide the lists in the two sublists

def merge_sort(list1, left_index, right_index):
    if left_index >= right_index: # условие для выхода из рекурсии
        return  # когда начальный индекс станет равным или более конечного выходим из рекурсии
